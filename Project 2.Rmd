...
OTHER POTENTIAL PLOT... 

```{r}
plot(plotdata$INJURIES,type = "l", col = "black", ylab = "Count of injuries/fatalites",xlab = "event type",xaxt = "n")
lines(plotdata$FATALITIES,type = "l", col = "red")
axis(1, at=1:10, labels=plotdata$EVTYPE)
```
